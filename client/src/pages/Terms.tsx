        ...
        <div className="bg-card rounded-lg p-8 shadow-sm border border-border">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              ...
              By using Word Counter Plus, you agree to these terms of service.
            </p>
          </div>
          <div className="prose prose-gray max-w-none text-muted-foreground space-y-6">
            ...
            <section>
              ...
              <p className="mb-4">By accessing and using Word Counter Plus, you accept and agree to be bound by the terms and provision of this agreement.</p>
            </section>

          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">Use of Service</h2>
            <p className="mb-4">Our <strong>word counter and text analysis tool</strong> is provided free of charge for personal and commercial use. You may use it to:</p>
            <ul className="list-disc ml-6 mb-4">
              <li>Analyze text for word count, readability, and keyword density</li>
